...
<!-- 				<th class="saleNum">(開発テスト)受注日</th> -->
			...
			<nested:iterate property="leaveStockList" indexId="idx">
				...
				<tr class="leaveStockRow">
					...
					<nested:hidden property="sysSalesSlipId"/>
...
<%-- 						<nested:write property="orderTime" /></td> --%>
					...
					<td class="shipmentPlanDate"><nested:write property="shipmentPlanDate" /></td>
	...
	<div class="paging_area">
		<div class="button_area">
			...
			<a class="button_white" href="javascript: void(0);" onclick="goTransaction('saleListPageNo.do');">戻る</a>
		</div>
	</div>
	</nested:form>
