...
//通貨コードの表示処理
	...
	$("#registry").click (function () {
		...
		removeCommaList($(".priceTextMinus"));
		removeCommaGoTransaction('registryCorporateSales.do');
	});
	...
	$("#update").click (function () {
		...
		if ($("#paymentMethod").val() == 2) {
			...
			removeCommaList($(".priceTextMinus"));
			removeCommaGoTransaction('updateDetailCorporateSale.do');
		} else{
...
//BONCRE-3408 kts_業販一覧の赤伝で登録後に修正を行おうとすると、『入金額が合計金額を超えています』と表示されず、更新ができる。
...
<%-- 					<td><html:text property="salesItemList[${idx}].cost" styleClass="price_w80 cost priceTextMinus" disabled="${disabled}" maxlength="9"/></td> --%>
					...
					<td class="nw"><html:text property="corporateSalesItemList[${idx}].leavingDate" styleClass="text_w80 leavingDate calender me_off" maxlength="10" readonly="true"/></td>
<%-- 					<td><html:text property="corporateSalesItemList[${idx}].leavingNum" /></td> --%>
					<td style="font-size: 18px;"><span class="leavingNum"><bean:write name="corporateSalesItemList" property="leavingNum" /></span></td>
					<td><html:text property="corporateSalesItemList[${idx}].salesDate" styleClass="text_w80 salesDate calender me_off" readonly="true"/></td>
...
<!-- 				追加用 -->
				...
				<tr class="addSalesItemRow itemSearchRow">
					...
					<td class="nw"><html:text property="addCorporateSalesItemList[${idx}].leavingDate" styleClass="text_w80 addLeavingDate calender me_off" readonly="true"/></td>
<%-- 					<td><html:text property="addCorporateSalesItemList[${idx}].leavingNum" /></td> --%>
					...
					<td><html:text property="addCorporateSalesItemList[${idx}].salesDate" styleClass="text_w80 addSalesDate calender me_off" readonly="true"/></td>
