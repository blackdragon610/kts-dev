 ...
 * @author ytakahashi
 */
public class IsErrFunction extends AbstractFunction implements BooleableFormula {

	/**
	 * 式シンボル.
	 */
	public static final String FORMULA_SYMBOL = "ISERR";
	 ...
	 */
	public IsErrFunction(Referencable ref) {
		this.ref = ref;
	}
