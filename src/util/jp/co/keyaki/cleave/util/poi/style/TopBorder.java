 ...
 *
 */
public class TopBorder extends Border implements CellStyleLazyDecorator {

	/**
	 * 細い実線・黒色。
	 */
	public static TopBorder THIN = new TopBorder(CellStyle.BORDER_THIN, ColorUtils.BLACK);
	/**
	 * 点線・黒色。
	 */
	public static TopBorder DOTTED = new TopBorder(CellStyle.BORDER_DOTTED, ColorUtils.BLACK);
	/**
	 * 点線・灰色50%。
	 */
	public static TopBorder DOTTED_GREY_50 = new TopBorder(CellStyle.BORDER_DOTTED, ColorUtils.GREY_50_PERCENT);
	/**
	 * 枠線無し（枠線を消す）。
	 */
	public static TopBorder NONE = new TopBorder(CellStyle.BORDER_NONE);

	/**
	 * コンストラクタ。
	 *
	 * 枠線オブジェクトの枠線の形状・枠線色と同一の上枠線オブジェクトを作成するコンストラクタ。
	 *
	 * @param source 複製元枠線オブジェクト
	 */
	public TopBorder(Border source) {
		super(source);
	}
	 ...
	 * @see CellStyle
	 */
	public TopBorder(short borderType) {
		super(borderType);
	}
	 ...
	 */
	public TopBorder(Color borderColor) {
		super(borderColor);
	}
	 ...
	 * @see CellStyle
	 */
	public TopBorder(short borderType, Color borderColor) {
	 ...
	 */
	public TopBorder(short borderType, short borderColorIndex) {
	...
	public void decorateLazy(CellStyle style, Cell cell,
		...
		style.setBorderTop(getBorderType());
		if (getBorderType() != CellStyle.BORDER_NONE) {
			style.setTopBorderColor(getBorderColor().getIndex());
		}
	}
