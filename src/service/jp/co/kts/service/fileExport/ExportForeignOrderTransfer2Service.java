...
/**
 * ［概要］振込依頼書（2）のServiceクラス
 * ［詳細］海外注文管理詳細画面において、PDF出力を行うクラス
 * @author Boncre
 *
 */
public class ExportForeignOrderTransfer2Service {
	...
	public void orderAcceptanceList(HttpServletResponse response,
		...
		PdfWriter writer = PdfWriter.getInstance(document,new FileOutputStream("ordertrance2.pdf"));
...
//		Font font = FontFactory.getFont(FontFactory.HELVETICA, 10);
	...
	private static void orderAcceptanceHeader(Document document, PdfWriter writer,
		...
		// 年月日の設定
//		String dates = DateUtil.dateToString("yyyy/MM/dd");
//		pdfContentByte.showText(dates);
...
//		Font font_HELVETICA = FontFactory.getFont(FontFactory.HELVETICA, 10);
		...
		pdfPTableSecond.setHorizontalAlignment(1);
		...
		//テーブル描画
		pdfPTableSecond.writeSelectedRows(0, TABLE_COLS_SECOND, 0, 20, 50, 345,
		writer.getDirectContent());
	}
