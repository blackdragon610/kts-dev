...
public class CoreException extends Exception {
	 ...
	 */
	public CoreException(MessageDefine messageDefine) {
		super();
	 ...
	 */
	public CoreException(MessageDefine messageDefine, String message) {
		super(message);
		setErrorDefine(messageDefine);
	}
	 ...
	 * @param cause 起因例外
	 */
	public CoreException(MessageDefine messageDefine, Throwable cause) {
		super(cause);
		setErrorDefine(messageDefine);
	}
	 ...
	 * @param cause 起因例外
	 */
	public CoreException(MessageDefine messageDefine, String message, Throwable cause) {
		super(message, cause);
		setErrorDefine(messageDefine);
	}
